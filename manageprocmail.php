...
//        \Tracy\Debugger::barDump($this->rc->config->get('trash_mbox'));
    ...
    function generate_script()
    {
        ...
        $header = (new Ingo_Script_Procmail_Comment('Procmail script generated by Ingo (hash:'. md5($content) .')', false, true))->generate();
        $footer = (new Ingo_Script_Procmail_Comment('== END OF GENERATED CONTENT'))->generate();

        return implode(PHP_EOL, [$header, $content, $footer]);
    }
